      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            <Image src="/indiamara-sorridendo.png" alt="Indiamara S. Domingues" width={180} height={240} className="h-32 w-auto mb-4 rounded" unoptimized />
        ...
        <div className="border-t border-gold/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-gray-700 text-xs">
            Desenvolvido por <span className="text-gold/60">RC Content Ltda</span>
          </p>
        </div>
      </div>
    </footer>
